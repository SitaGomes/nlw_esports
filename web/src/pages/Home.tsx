              ...
              <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-black/25">
                ...
                <Dialog.Title className="text-3xl font-black">Publique um anúncio</Dialog.Title>
                  ...
                  <form className="mt-8 flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                      <label htmlFor="name">Qual é o seu Nickname?</label>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      <div className="flex flex-col gap-2">
                        ...
                        <Input type="text" placeholder="tudo bem ser ZERO" id="yearsPlaying" />
                      </div>
                    ...
                    <footer className="mt-4 flex justify-end gap-4">
                      <Dialog.Close className="bg-zinc-500 px-5 h-12 rounded font-semibold hover:bg-zinc-600">Cancelar</Dialog.Close>
                      <button 
                        type="submit"
